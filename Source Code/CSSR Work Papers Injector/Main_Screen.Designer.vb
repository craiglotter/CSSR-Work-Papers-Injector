...
Partial Class Main_Screen
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label5.Text = "CSSR Working Papers Database:"
        '
        'Button2
        '
        ...
        Me.Label1.Text = "Folder Containing Working Paper HTML files:"
        '
        'MenuStrip1
        '
        ...
        Me.OpenFileDialog1.Title = "Select the CSSR Working Papers database you wish to use"
        '
        'Main_Screen
        '
